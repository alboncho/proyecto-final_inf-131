 ...
 * @author alboncho
 */
public class PersistenciaColaEncomienda {
   private static final String NOMBRE = "datos/DatoColaEncomienda.dat";
   
   public static void guardar(MC_Encomienda mce) {
      try { 
